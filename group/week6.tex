...
\begin{definition}
  ...
  Write $\Fix G \defeq \{\, \times \in \times \mid gx = \times \quad \forall g \in G \,\}$.
\end{definition}

\begin{itemize}
  \item $x \in \Fix G$, $Gx = \{ \times \}$.
  \item $x \not\in \Fix G$, $\abs{Gx} = [G : G_x]$.
\end{itemize}

Let $\{ G_{\times_1}, \dots, G_{\times_n} \}$ be the set of distinct orbits.
After rearrangement, assume $\times_1, \dots, \times_r \in \Fix G,
\times_{r+1}, \dots, \times_n \not\in \Fix G$. Then
\[
  \abs{X} = \abs{\Fix G} + \sum_{i=r+1}^{n} [G : G_{\times_i}]
\]
...
\begin{theorem}[class equation]
  ...
  \begin{proof}
    ...
    \[
      \Fix G = \{\, \times \in G \mid gxg^{-1} = \times \quad \forall g \in G \,\}
      = Z_G
    \]
...
\begin{theorem}[Cauchy theorem]
  ...
  \[ \times = \{\, (a_1, \dots, a_p) \mid a_i \in G, a_1a_2\dots a_p = 1\,\} \]
  and the action $\quot{\Zb}{p\Zb} \times \times \to X$:
  \[
...
$\phi_k_2 o \phi_k_1 (T) = \phi_k_2(\bar(k_1)) = \phi_k_2(T+\cdots+T) = \bar(k_2) + \cdots \bar{k_2} = \bar{k_1 k_2}$
