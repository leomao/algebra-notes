...
\begin{definition} \hfill
  \begin{itemize}
    ...
    \item An abelian category is said to have {\bf enough injectives} if
      for any $A \in \Obj \Ac$, exists $I$ injective such that $A \hookrightarrow I$.
  \end{itemize}
\end{definition}
...
\begin{remark} \hfill
  \begin{itemize}
    ...
    \item It could be shown that $K(A)$ is additive but may not be abelian.
  \end{itemize}
\end{remark}
...
\begin{example}
  \begin{itemize}
    ...
    \item Given $0 \to A \to I^\bullet$,
      ...
      \end{tikzcd} \]
    are two quasi-isomorphic complex.
  \end{itemize}
\end{example}
...
\begin{theorem}
  ...
  \begin{enumerate}
    ...
    \item Given another functor $F : B \to B'$ satisfy condition 1., exists
  ...
  \begin{proof}
    ...
    \[ \begin{tikzcd}[column sep=tiny, row sep=small]
      ...
      X & & Y
    \end{tikzcd} \]
  Also, define $(s, f) \sim (t, g)$ if exists $Z$ such that
  ...
  is another functor letting every morphism in $S$ be invertible,
