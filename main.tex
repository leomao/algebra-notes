...
\newcommand*{\existsuniq}{\existstemp!\mkern4mu}
...
\newcommand\tridot{\triangle\kern-1.42ex\raisebox{.13ex}{\scalebox{0.7}{$\bullet$}}\kern+0.6ex}
...
\include{homology/week15}
\include{homology/week16}
\include{homology/week17}
\printindex
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
